...
const Hero = () => {
  return (
    <>
      ...
      <div
        id="home"
        className="bg-[url(/assets/images/webp/hero-bg.webp)] bg-no-repeat bg-cover relative bg-center"
      >
        <div className="max-w-[1172px] px-4 mx-auto relative z-20 pt-[197px] pb-[168px] max-md:py-32 max-sm:py-20 max-sm:bg-black/50">
          <Description
