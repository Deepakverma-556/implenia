        ...
        <div className="max-w-[1103px] mx-auto">
          <div className="flex -mx-[25.5px] max-lg:-mx-3 max-md:flex-wrap justify-center">
            {STORIES_LIST.map((obj: StoriesItem, i: number) => (
              ...
              >
                <div className="border border-black rounded-[28px] max-sm:rounded-2xl h-full overflow-hidden">
                  <Image
                    src={obj.image}
                    alt={obj.imageAlt}
                    width={323}
                    height={207}
                    className="w-full max-sm:h-[190px] max-sm:rounded-2xl max-xl:h-[200px] object-cover rounded-[28px] pointer-events-none"
                  />
                  <p className="font-semibold text-[35px] max-lg:text-3xl max-sm:text-2xl leading-[44px] pt-[51px] pb-16 px-6 max-sm:py-9">
                    {obj.title}
                  </p>
                </div>
              </div>
